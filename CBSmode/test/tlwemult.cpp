 ...
 * @LastEditTime: 2023-02-18 10:55:49
 * @Description: 
 * @FilePath: /tfhepp/test/tlwemult.cpp
 */
...
int main()
{
    ...
    for (int test = 0; test < num_test; test++) {
        ...
        TFHEpp::TLWE<P> c0 =
            TFHEpp::tlweSymIntEncrypt<P>(p0, P::alpha, sk->key.get<P>());
        TFHEpp::TLWE<P> c1 =
            TFHEpp::tlweSymIntEncrypt<P>(p1, P::alpha, sk->key.get<P>());
        TFHEpp::TLWE<P> cres;
