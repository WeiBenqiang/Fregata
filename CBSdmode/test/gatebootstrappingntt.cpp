 ...
 * @LastEditTime: 2023-02-07 20:02:14
 * @Description: 
 * @FilePath: /tfhepp/test/gatebootstrappingntt.cpp
 */
/*
 * @Author: Wei Benqiang
 * @Date: 2023-02-07 10:16:49
 * @LastEditors: Do not edit
 * @LastEditTime: 2023-02-07 19:58:10
 * @Description: 
 * @FilePath: /tfhepp/test/gatebootstrappingntt.cpp
 */
#include <cassert>
...
int main()
{
    ...
    for(int i = 0; i < num_test; i++) tlwe[i] =
            TFHEpp::tlweSymEncrypt<TFHEpp::lvl1param>(
                p[i] ? TFHEpp::lvl1param::mu : -TFHEpp::lvl1param::mu,
