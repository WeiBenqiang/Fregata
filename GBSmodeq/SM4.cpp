...
static unsigned long sm4Lt(unsigned long ka)
{
    ...
    b[2] = sm4Sbox(a[2]);
    b[3] = sm4Sbox(a[3]);
    // printf("a0--b0:%02x, %02x\n",a[0], b[0]);
    // printf("a1--b1:%02x, %02x\n",a[1], b[1]);
    // printf("a2--b2:%02x, %02x\n",a[2], b[2]);
    // printf("a3--b3:%02x, %02x\n",a[3], b[3]);
...
void sm4_enc_128bit(unsigned long sk[32],
                    unsigned char input[16],
                    unsigned char output[16])
{
...
void sm4_dec_128bit(unsigned long sk[32],
                    unsigned char input[16],
                    unsigned char output[16])
{
    int i;
...
void sm4_enc(unsigned long sk[32],
             unsigned char *input,
             unsigned char *output)
{
    printf("%s \n", "........Encrypt......");
    sm4_enc_128bit(sk, input, output);
}

void sm4_dec(unsigned long sk[32],
             unsigned char *input,
             unsigned char *output)
{
    printf("%s \n", "........Decrypt......");
...
int main()
{
    ...
    sm4_enc(sk, input, output);  //0代表加密模式
    for(i = 0; i < 16; i++)
    {
        printf("%02x ", output[i]);
        // input[i] = output[i];
    ...
    // decrypt ecb
    // sm4_dec(sk, input, output);   //1代表解密模式
    // for(i = 0; i < 16; i++)
    //    printf("%02x ", output[i]);
}
*/
